...
external interface AesCbcParams : Algorithm {
    var iv: Uint8Array /* Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer */
}
...
//    var additionalData: Uint8Array? /* Int8Array? | Int16Array? | Int32Array? | Uint8Array? | Uint16Array? | Uint32Array? | Uint8ClampedArray? | Float32Array? | Float64Array? | DataView? | ArrayBuffer? */
//    var iv: Uint8Array /* Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer */
//    var tagLength: Int?
//}
//
...
//        algorithm: String,
//        key: CryptoKey,
//        data: Any /* Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer */
//    ): Promise<ArrayBuffer>
//
//    fun decrypt(
//        algorithm: Algorithm,
...
//    ): Promise<ArrayBuffer>
//
//    fun deriveBits(algorithm: String, baseKey: CryptoKey, length: Number): Promise<ArrayBuffer>
//    fun deriveBits(algorithm: Algorithm, baseKey: CryptoKey, length: Number): Promise<ArrayBuffer>
//    fun deriveBits(algorithm: EcdhKeyDeriveParams, baseKey: CryptoKey, length: Number): Promise<ArrayBuffer>
//    fun deriveBits(algorithm: DhKeyDeriveParams, baseKey: CryptoKey, length: Number): Promise<ArrayBuffer>
//    fun deriveBits(algorithm: ConcatParams, baseKey: CryptoKey, length: Number): Promise<ArrayBuffer>
//    fun deriveBits(algorithm: HkdfCtrParams, baseKey: CryptoKey, length: Number): Promise<ArrayBuffer>
//    fun deriveBits(algorithm: Pbkdf2Params, baseKey: CryptoKey, length: Number): Promise<ArrayBuffer>
//    fun deriveKey(
//        algorithm: String,
//        baseKey: CryptoKey,
//        derivedKeyType: Any /* String | AesDerivedKeyParams | HmacImportParams | ConcatParams | HkdfCtrParams | Pbkdf2Params */,
//        extractable: Boolean,
...
//
    fun encrypt(
        algorithm: Algorithm,
        key: CryptoKey,
        data: Uint8Array /* Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer */
    ): Promise<ArrayBuffer>
...
//    ): Promise<ArrayBuffer>
//
//    fun exportKey(format: String /* "jwk" | "raw" | "pkcs8" | "spki" */, key: CryptoKey): dynamic /* Promise */
//    fun generateKey(
//        algorithm: String,
//        extractable: Boolean,
//        keyUsages: Array<String /* "decrypt" | "deriveBits" | "deriveKey" | "encrypt" | "sign" | "unwrapKey" | "verify" | "wrapKey" */>
//    ): Promise<dynamic /* CryptoKeyPair | CryptoKey */>
//
//    fun generateKey(
//        algorithm: Algorithm,
//        extractable: Boolean,
...
//        keyData: Int8Array,
//        algorithm: Any /* String | Algorithm | RsaHashedImportParams | EcKeyImportParams | HmacImportParams | DhImportKeyParams | AesKeyAlgorithm */,
//        extractable: Boolean,
//        keyUsages: Array<String /* "decrypt" | "deriveBits" | "deriveKey" | "encrypt" | "sign" | "unwrapKey" | "verify" | "wrapKey" */>
//    ): Promise<CryptoKey>
//
...
//
//    fun unwrapKey(
//        format: String /* "raw" | "pkcs8" | "spki" | "jwk" | String */,
//        wrappedKey: Int8Array,
//        unwrappingKey: CryptoKey,
//        unwrapAlgorithm: Any /* String | Algorithm | RsaOaepParams | AesCtrParams | AesCbcParams | AesCmacParams | AesGcmParams | AesCfbParams */,
//        unwrappedKeyAlgorithm: Any /* String | Algorithm | RsaHashedImportParams | EcKeyImportParams | HmacImportParams | DhImportKeyParams | AesKeyAlgorithm */,
//        extractable: Boolean,
//        keyUsages: Array<String /* "decrypt" | "deriveBits" | "deriveKey" | "encrypt" | "sign" | "unwrapKey" | "verify" | "wrapKey" */>
//    ): Promise<CryptoKey>
//
...
//        algorithm: String,
//        key: CryptoKey,
//        signature: Any /* Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer */,
//        data: Any /* Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer */
//    ): Promise<Boolean>
//
//    fun verify(
