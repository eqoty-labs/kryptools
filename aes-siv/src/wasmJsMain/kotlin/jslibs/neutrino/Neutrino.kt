@file:JsModule("@solar-republic/neutrino")
...
external fun aes_128_siv_encrypt(
    atu8_key: Uint8Array, atu8_plaintext: Uint8Array, a_ad: JsArray<Uint8Array> = definedExternally
): Promise<Uint8Array>
...
external fun aes_128_siv_decrypt(
    atu8_key: Uint8Array, atu8_payload: Uint8Array, a_ad: JsArray<Uint8Array> = definedExternally
): Promise<Uint8Array>